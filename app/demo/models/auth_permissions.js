module.exports = Model.extend({
	...
	config: {
		group_id: { type: ObjectId, ref: 'auth_groups', required: true, label: "Group"},
		menu_action_id: { type: ObjectId, ref: 'auth_menu_action', required: true, label: "Action"},
		create_by: { type: ObjectId, ref: 'auth_users', required: false, hide: true},
